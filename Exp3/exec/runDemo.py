...
from src.Trial import TrialForDemo
...
def main():
    ...
    saveImageDir = os.path.abspath(os.path.join(os.getcwd(), os.pardir)) + '/demoImg/'
    trial = TrialForDemo(controller, drawNewState, checkBoundary, saveImageDir)
